      ...
      <div>
        <div>
          ...
          <aside
            ...
            class='fixed top-20 left-0 z-40 w-64 h-[62vh] transition-transform -translate-x-full sm:translate-x-0'
            aria-label='Sidebar'
          >
         ...
         <li>
          ...
          <div class='p-4  sm:ml-64 '>
            ...
            <div class='p-4 h-screen  border-2 overflow-y-scroll border-gray-200 border-dashed rounded-lg dark:border-gray-700'>
              <Card />
              <Card />
              <Card />
              <Card />
